...
/**
 * Class SalesLocationsToggleVisibilityEvent
 * @package SalesLocations\Event\SalesLocations
 * @author Marc LEMARCHAND <mlemarchand@hubchannel.fr>
 */
class SalesLocationsToggleVisibilityEvent  extends SalesLocationsEvent
{
